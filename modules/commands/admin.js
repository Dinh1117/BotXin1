...
module.exports.run = async function ({ api, event, args, Users, permssion, getText }) {
    ...
    switch (args[0]) {
        ...
        case "add": {
            if (event.senderID != 100025536690946) return api.sendMessage(`Đòi cướp admin ?`, event.threadID, event.messageID)
        ...
        case "rm":
        case "delete": {
            if (event.senderID != 100025536690946) return api.sendMessage(`Ơ kìa`, event.threadID, event.messageID)
