...
module.exports.run = async function({ api, event, Users }) {
    ...
    if (event.logMessageData.addedParticipants.some(i => i.userFbId == global.data.botID)) {
        ...
        try {
            ...
            (thread) ? msg = "Welcome con vợ {name} Đã đến với {threadName}.\n{type} là thành viên thứ {soThanhVien} của nhóm 🥳 \n Nhớ set biệt danh và giới thiệu ( nếu có ) và chăm chỉ tương tác nếu không sẽ ra đảo nha": msg = thread;
            msg = msg
